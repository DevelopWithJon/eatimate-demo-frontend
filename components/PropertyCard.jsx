...
const PropertyCard = ({ property, onDelete }) => {
  ...
  return (
    ...
    >
      {/* Shader Dropdown */}
      <div
        className={`w-full overflow-y-clip rounded-lg bg-[#333333] p-2 text-white transition-all duration-300 ease-in-out ${visible ? 'flex h-full flex-col justify-between bg-opacity-75' : 'h-fit bg-opacity-50'}`}
      >
